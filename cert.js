...
$(document).ready(function () {
    for (let i = 1; i < 10; i++) {
        $('.flex-container').append('<img class="flex-item" src="certificates/cert' + i + '.jpg" height="500px" srcset="">')
    ...
    $('.download').attr('href','certificates/cert' + 1 + '.pdf')
    ...
    $('#right-click').click(function(self) {
        ...
        $('.download').attr('href','certificates/cert' + (certID + 1) + '.pdf')
